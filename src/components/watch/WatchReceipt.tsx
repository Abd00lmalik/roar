  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="glass-panel w-full max-w-lg space-y-3 p-5">
        ...
        <p>Treasury: {formatUsdc(summary.platformShareUsdc)} USDC (5%)</p>
        <p>Fan rewards: {formatUsdc(summary.rewardPoolShareUsdc)} USDC (10%)</p>
        <p className="text-xs text-chalk/70">TX: {txHash ?? "circle_pending"}</p>
