...
export type { StadiumAdBoard } from "./src/StadiumAdBoard";
export { StadiumAdBoard__factory } from "./factories/src/StadiumAdBoard__factory";
export type { IFanPassport } from "./src/VARSystem.sol/IFanPassport";
