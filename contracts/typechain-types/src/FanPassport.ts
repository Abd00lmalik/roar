...
export interface FanPassport extends BaseContract {
  connect(runner?: ContractRunner | null): FanPassport;
  waitForDeployment(): Promise<this>;

  interface: FanPassportInterface;
  ...
  getEvent(
    ...
    PassportMintedEvent.OutputObject
  >;
  getEvent(
    key: "Transfer"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "PassportMinted(address,uint256,string)": TypedContractEvent<
      ...
      PassportMintedEvent.OutputObject
    >;
    PassportMinted: TypedContractEvent<
      PassportMintedEvent.InputTuple,
      PassportMintedEvent.OutputTuple,
      PassportMintedEvent.OutputObject
    >;
